...
- After creating the change artifacts, run `node "${CLAUDE_HOME:-$HOME/.claude}/forgevia/bin/validate-openspec-cn.mjs" --root <project-root>`. Do not report the proposal as strictly valid if this command fails.

...
- After creating the change artifacts, run `"{{PLATFORM_HOME_ENV}}/forgevia/bin/forgevia" validate --root <project-root>`. Do not report the proposal as strictly valid if this command fails.

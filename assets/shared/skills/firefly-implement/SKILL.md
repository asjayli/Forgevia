---
name: firefly-implement
description: Use when the user explicitly asks firefly to implement one named, active OpenSpec change using superpowers with a TDD workflow.
---

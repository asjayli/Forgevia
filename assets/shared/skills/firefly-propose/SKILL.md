...
- After creating the change artifacts, run `"{{PLATFORM_HOME_ENV}}/firefly/bin/firefly" validate --root <project-root>`. Do not report the proposal as strictly valid if this command fails.

...
- Run `"{{PLATFORM_HOME_ENV}}/forgevia/bin/forgevia" validate --root <project-root>` before the review. Treat a non-zero result as a blocking OpenSpec finding and report its file-level output.

...
- Backed by the installed runtime script `{{PLATFORM_HOME_ABS}}/forgevia/bin/list-change-tasks.sh`; run it as `bash "{{PLATFORM_HOME_ABS}}/forgevia/bin/list-change-tasks.sh" [project_dir]` (defaults to the current directory).

...
- After creating the change artifacts, run `"${CODEX_HOME:-$HOME/.codex}/firefly/bin/firefly" validate --root <project-root>`. Do not report the proposal as strictly valid if this command fails.

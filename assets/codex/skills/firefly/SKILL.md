...
- firefly-managed overrides are present under `~/.codex`
...
- prefer `--tools codex,claude` when the repository should support both firefly clients
...
Purpose:
- inspect the current Codex environment for missing or drifted firefly-managed assets

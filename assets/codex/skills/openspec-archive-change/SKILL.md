...
**Independent review contract:** An explicit archive request authorizes the named change's spec sync and local archive move. Use `spawn_agent` for an independent reviewer different from the candidate producer. Every review package contains:

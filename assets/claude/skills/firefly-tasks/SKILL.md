...
- Backed by the installed runtime script `$HOME/.claude/firefly/bin/list-change-tasks.sh`; run it as `bash "$HOME/.claude/firefly/bin/list-change-tasks.sh" [project_dir]` (defaults to the current directory).
